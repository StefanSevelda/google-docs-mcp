// src/tools/DriveTools.ts
import { FastMCP, UserError } from 'fastmcp';
import { z } from 'zod';
import { docs_v1, drive_v3 } from 'googleapis';
import { getDriveClient, getDocsClient } from '../clients/googleClients.js';
...
export class DriveTools {
     ...
     */
    private static escapeDriveQuery(input: string): string {
        ...
        server.addTool({
            ...
            execute: async (args, { log }) => {
                ...
                try {
                    ...
                    if (args.query) {
                        const escapedQuery = DriveTools.escapeDriveQuery(args.query);
        ...
        server.addTool({
            ...
            execute: async (args, { log }) => {
                ...
                try {
                    ...
                    const escapedQuery = DriveTools.escapeDriveQuery(args.searchQuery);
                    ...
                    if (args.modifiedAfter) {
                        const escapedDate = DriveTools.escapeDriveQuery(args.modifiedAfter);
